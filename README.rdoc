...
== Kibana3 Milestone 4 support

Is currently being tested and will be released in a week or so. If you would
like to upgrade now, simply checkout master instead of v1.0.0 and re-configure
the kibana/ submodule.
