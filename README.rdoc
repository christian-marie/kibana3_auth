...
to authenticate and view thier logs based on certain filters. Also I didn't
really want dependencies, so there are none besides rack and JSON.

So I did that, then I tried to make it re-usable for someone else. This is the
result.
...
== Upgrading from Kibana3 Milestone 3 to Milestone 4

If you had a custom javascript config, this will blow it away. If you want to
