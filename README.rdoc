...
* Firefox -- Some have reported that Safari will not work without the Thin
	     webserver. I cannot confirm this.
...
preserve that, I'm sure you can work out how.
 ...
 $ cd kibana3_auth
 $ git pull && git checkout v1.0.1milestone4
...
We need to download this repo, kibana, and rack.
  ...
  $ cd kibana3_auth && git checkout v1.0.1milestone4
